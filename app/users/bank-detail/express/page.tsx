...
function ExpressContent() {
    ...
    return (
        <div className="min-h-screen bg-[#F8FAFF] text-slate-900 pb-40 font-sans">
            {/* Header - Orange for Express */}
            <div className="bg-[#F97316] pt-12 pb-16 px-6 rounded-b-[3rem] relative overflow-hidden">
                        ...
                        <div className="space-y-3">
                            ...
                            <div className="flex items-center justify-between gap-4">
                                ...
                                <button
                                    ...
                                    className={`px-6 py-2 rounded-full font-bold text-sm transition-all active:scale-95 ${copiedName ? 'bg-orange-500 text-white' : 'bg-[#FFF2E7] text-[#F97316]'
                                        }`}
                                >
                        ...
                        <div className="space-y-3">
                            ...
                            <div className="flex items-center justify-between gap-4">
                                ...
                                <button
                                    ...
                                    className={`px-6 py-2 rounded-full font-bold text-sm transition-all active:scale-95 ${copiedAccount ? 'bg-orange-500 text-white' : 'bg-[#FFF2E7] text-[#F97316]'
                                        }`}
                                >
